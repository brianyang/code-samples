    ...
    return (<div className={styles.wrapper}>
      ...
      <div className="aboutRacket">
        <div className="container">
          ...
          <p>
            Racket is a yeoman generator for creating universal/isomorphic web applications. One of
            the pains for developers who want to use React or want to develop universal apps was
            knowing which libraries to choose and how tie them up! Racket responds to this issue by
            giving you the option to choose the tools/technologies that you prefer the most and
            offering a good structure that you can maintain for years!
          </p>
          <h2>Technologies</h2>
          <p>
          ...
          <ul>
            <li>
              <strong>Universal/Isomorphic</strong> JavaScript code is a code that can execute both
              on the client and
            ...
            <li>
              <strong>Server-side data loading</strong> using redux-connect.
              {' '}
              Take a look at <Link to="/hottest">Github hottest page</Link>.
            </li>
          </ul>
        </div>
      </div>
